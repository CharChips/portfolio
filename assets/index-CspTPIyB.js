 ...
 */var Rd;function Dp(){if(Rd)return zn;Rd=1;var c=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function m(s,d,b){var T=null;if(b!==void 0&&(T=""+b),d.key!==void 0&&(T=""+d.key),"key"in d){b={};for(var D in d)D!=="key"&&(b[D]=d[D])}else b=d;return d=b.ref,{$$typeof:c,type:s,key:T,ref:d!==void 0?d:null,props:b}}return zn.Fragment=f,zn.jsx=m,zn.jsxs=m,zn}var wd;function Cp(){return wd||(wd=1,yc.exports=Dp()),yc.exports}var r=Cp(),xc={exports:{}},ee={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Od;function Up(){return Od||(Od=1,function(c){function f(M,L){var W=M.length;M.push(L);e:for(;0<W;){var pe=W-1>>>1,g=M[pe];if(0<d(g,L))M[pe]=L,M[W]=g,W=pe;else break e}}function m(M){return M.length===0?null:M[0]}function s(M){if(M.length===0)return null;var L=M[0],W=M.pop();if(W!==L){M[0]=W;e:for(var pe=0,g=M.length,U=g>>>1;pe<U;){var q=2*(pe+1)-1,B=M[q],Z=q+1,oe=M[Z];if(0>d(B,W))Z<g&&0>d(oe,B)?(M[pe]=oe,M[Z]=W,pe=Z):(M[pe]=B,M[q]=W,pe=q);else if(Z<g&&0>d(oe,W))M[pe]=oe,M[Z]=W,pe=Z;else break e}}return L}function d(M,L){var W=M.sortIndex-L.sortIndex;return W!==0?W:M.id-L.id}if(c.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var b=performance;c.unstable_now=function(){return b.now()}}else{var T=Date,D=T.now();c.unstable_now=function(){return T.now()-D}}var x=[],p=[],A=1,O=null,_=3,k=!1,X=!1,Q=!1,V=!1,H=typeof setTimeout=="function"?setTimeout:null,re=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function xe(M){for(var L=m(p);L!==null;){if(L.callback===null)s(p);else if(L.startTime<=M)s(p),L.sortIndex=L.expirationTime,f(x,L);else break;L=m(p)}}function F(M){if(Q=!1,xe(M),!X)if(m(x)!==null)X=!0,Oe||(Oe=!0,Ge());else{var L=m(p);L!==null&&Xe(F,L.startTime-M)}}var Oe=!1,we=-1,Ue=5,Ne=-1;function Pe(){return V?!0:!(c.unstable_now()-Ne<Ue)}function st(){if(V=!1,Oe){var M=c.unstable_now();Ne=M;var L=!0;try{e:{X=!1,Q&&(Q=!1,re(we),we=-1),k=!0;var W=_;try{t:{for(xe(M),O=m(x);O!==null&&!(O.expirationTime>M&&Pe());){var pe=O.callback;if(typeof pe=="function"){O.callback=null,_=O.priorityLevel;var g=pe(O.expirationTime<=M);if(M=c.unstable_now(),typeof g=="function"){O.callback=g,xe(M),L=!0;break t}O===m(x)&&s(x),xe(M)}else s(x);O=m(x)}if(O!==null)L=!0;else{var U=m(p);U!==null&&Xe(F,U.startTime-M),L=!1}}break e}finally{O=null,_=W,k=!1}L=void 0}}finally{L?Ge():Oe=!1}}}var Ge;if(typeof P=="function")Ge=function(){P(st)};else if(typeof MessageChannel<"u"){var Sa=new MessageChannel,ja=Sa.port2;Sa.port1.onmessage=st,Ge=function(){ja.postMessage(null)}}else Ge=function(){H(st,0)};function Xe(M,L){we=H(function(){M(c.unstable_now())},L)}c.unstable_IdlePriority=5,c.unstable_ImmediatePriority=1,c.unstable_LowPriority=4,c.unstable_NormalPriority=3,c.unstable_Profiling=null,c.unstable_UserBlockingPriority=2,c.unstable_cancelCallback=function(M){M.callback=null},c.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ue=0<M?Math.floor(1e3/M):5},c.unstable_getCurrentPriorityLevel=function(){return _},c.unstable_next=function(M){switch(_){case 1:case 2:case 3:var L=3;break;default:L=_}var W=_;_=L;try{return M()}finally{_=W}},c.unstable_requestPaint=function(){V=!0},c.unstable_runWithPriority=function(M,L){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var W=_;_=M;try{return L()}finally{_=W}},c.unstable_scheduleCallback=function(M,L,W){var pe=c.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?pe+W:pe):W=pe,M){case 1:var g=-1;break;case 2:g=250;break;case 5:g=1073741823;break;case 4:g=1e4;break;default:g=5e3}return g=W+g,M={id:A++,callback:L,priorityLevel:M,startTime:W,expirationTime:g,sortIndex:-1},W>pe?(M.sortIndex=W,f(p,M),m(x)===null&&M===m(p)&&(Q?(re(we),we=-1):Q=!0,Xe(F,W-pe))):(M.sortIndex=g,f(x,M),X||k||(X=!0,Oe||(Oe=!0,Ge()))),M},c.unstable_shouldYield=Pe,c.unstable_wrapCallback=function(M){var L=_;return function(){var W=_;_=L;try{return M.apply(this,arguments)}finally{_=W}}}}(Nc)),Nc}var Ud;function _p(){return Ud||(Ud=1,jc.exports=Up()),jc.exports}var Ec={exports:{}},Ze={};/**
 * @license React
 ...
 *
 * @license MIT
 */var qd="popstate";function kp(c={}){function f(s,d){let{pathname:b,search:T,hash:D}=s.location;return Mc("",{pathname:b,search:T,hash:D},d.state&&d.state.usr||null,d.state&&d.state.key||"default")}function m(s,d){return typeof d=="string"?d:Dn(d)}return Xp(f,m,null,c)}function je(c,f){if(c===!1||c===null||typeof c>"u")throw new Error(f)}function Rt(c,f){if(!c){typeof console<"u"&&console.warn(f);try{throw new Error(f)}catch{}}}function Gp(){return Math.random().toString(36).substring(2,10)}function Yd(c,f){return{usr:c.state,key:c.key,idx:f}}function Mc(c,f,m=null,s){return{pathname:typeof c=="string"?c:c.pathname,search:"",hash:"",...typeof f=="string"?zl(f):f,state:m,key:f&&f.key||s||Gp()}}function Dn({pathname:c="/",search:f="",hash:m=""}){return f&&f!=="?"&&(c+=f.charAt(0)==="?"?f:"?"+f),m&&m!=="#"&&(c+=m.charAt(0)==="#"?m:"#"+m),c}function zl(c){let f={};if(c){let m=c.indexOf("#");m>=0&&(f.hash=c.substring(m),c=c.substring(0,m));let s=c.indexOf("?");s>=0&&(f.search=c.substring(s),c=c.substring(0,s)),c&&(f.pathname=c)}return f}function Xp(c,f,m,s={}){let{window:d=document.defaultView,v5Compat:b=!1}=s,T=d.history,D="POP",x=null,p=A();p==null&&(p=0,T.replaceState({...T.state,idx:p},""));function A(){return(T.state||{idx:null}).idx}function O(){D="POP";let V=A(),H=V==null?null:V-p;p=V,x&&x({action:D,location:Q.location,delta:H})}function _(V,H){D="PUSH";let re=Mc(Q.location,V,H);p=A()+1;let P=Yd(re,p),xe=Q.createHref(re);try{T.pushState(P,"",xe)}catch(F){if(F instanceof DOMException&&F.name==="DataCloneError")throw F;d.location.assign(xe)}b&&x&&x({action:D,location:Q.location,delta:1})}function k(V,H){D="REPLACE";let re=Mc(Q.location,V,H);p=A();let P=Yd(re,p),xe=Q.createHref(re);T.replaceState(P,"",xe),b&&x&&x({action:D,location:Q.location,delta:0})}function X(V){return Vp(V)}let Q={get action(){return D},get location(){return c(d,T)},listen(V){if(x)throw new Error("A history only accepts one active listener");return d.addEventListener(qd,O),x=V,()=>{d.removeEventListener(qd,O),x=null}},createHref(V){return f(d,V)},createURL:X,encodeLocation(V){let H=X(V);return{pathname:H.pathname,search:H.search,hash:H.hash}},push:_,replace:k,go(V){return T.go(V)}};return Q}function Vp(c,f=!1){let m="http://localhost";typeof window<"u"&&(m=window.location.origin!=="null"?window.location.origin:window.location.href),je(m,"No window.location.(origin|href) available to create URL");let s=typeof c=="string"?c:Dn(c);return s=s.replace(/ $/,"%20"),!f&&s.startsWith("//")&&(s=m+s),new URL(s,m)}function Vd(c,f,m="/"){return Qp(c,f,m,!1)}function Qp(c,f,m,s){let d=typeof f=="string"?zl(f):f,b=Jt(d.pathname||"/",m);if(b==null)return null;let T=Qd(c);Zp(T);let D=null;for(let x=0;D==null&&x<T.length;++x){let p=lg(b);D=tg(T[x],p,s)}return D}function Qd(c,f=[],m=[],s=""){let d=(b,T,D)=>{let x={relativePath:D===void 0?b.path||"":D,caseSensitive:b.caseSensitive===!0,childrenIndex:T,route:b};x.relativePath.startsWith("/")&&(je(x.relativePath.startsWith(s),`Absolute route path "${x.relativePath}" nested under path "${s}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),x.relativePath=x.relativePath.slice(s.length));let p=Kt([s,x.relativePath]),A=m.concat(x);b.children&&b.children.length>0&&(je(b.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${p}".`),Qd(b.children,f,A,p)),!(b.path==null&&!b.index)&&f.push({path:p,score:Pp(p,b.index),routesMeta:A})};return c.forEach((b,T)=>{if(b.path===""||!b.path?.includes("?"))d(b,T);else for(let D of Zd(b.path))d(b,T,D)}),f}function Zd(c){let f=c.split("/");if(f.length===0)return[];let[m,...s]=f,d=m.endsWith("?"),b=m.replace(/\?$/,"");if(s.length===0)return d?[b,""]:[b];let T=Zd(s.join("/")),D=[];return D.push(...T.map(x=>x===""?b:[b,x].join("/"))),d&&D.push(...T),D.map(x=>c.startsWith("/")&&x===""?"/":x)}function Zp(c){c.sort((f,m)=>f.score!==m.score?m.score-f.score:eg(f.routesMeta.map(s=>s.childrenIndex),m.routesMeta.map(s=>s.childrenIndex)))}var Kp=/^:[\w-]+$/,Jp=3,Wp=2,$p=1,Fp=10,Ip=-2,kd=c=>c==="*";function Pp(c,f){let m=c.split("/"),s=m.length;return m.some(kd)&&(s+=Ip),f&&(s+=Wp),m.filter(d=>!kd(d)).reduce((d,b)=>d+(Kp.test(b)?Jp:b===""?$p:Fp),s)}function eg(c,f){return c.length===f.length&&c.slice(0,-1).every((s,d)=>s===f[d])?c[c.length-1]-f[f.length-1]:0}function tg(c,f,m=!1){let{routesMeta:s}=c,d={},b="/",T=[];for(let D=0;D<s.length;++D){let x=s[D],p=D===s.length-1,A=b==="/"?f:f.slice(b.length)||"/",O=er({path:x.relativePath,caseSensitive:x.caseSensitive,end:p},A),_=x.route;if(!O&&p&&m&&!s[s.length-1].route.index&&(O=er({path:x.relativePath,caseSensitive:x.caseSensitive,end:!1},A)),!O)return null;Object.assign(d,O.params),T.push({params:d,pathname:Kt([b,O.pathname]),pathnameBase:og(Kt([b,O.pathnameBase])),route:_}),O.pathnameBase!=="/"&&(b=Kt([b,O.pathnameBase]))}return T}function er(c,f){typeof c=="string"&&(c={path:c,caseSensitive:!1,end:!0});let[m,s]=ag(c.path,c.caseSensitive,c.end),d=f.match(m);if(!d)return null;let b=d[0],T=b.replace(/(.)\/+$/,"$1"),D=d.slice(1);return{params:s.reduce((p,{paramName:A,isOptional:O},_)=>{if(A==="*"){let X=D[_]||"";T=b.slice(0,b.length-X.length).replace(/(.)\/+$/,"$1")}const k=D[_];return O&&!k?p[A]=void 0:p[A]=(k||"").replace(/%2F/g,"/"),p},{}),pathname:b,pathnameBase:T,pattern:c}}function ag(c,f=!1,m=!0){Rt(c==="*"||!c.endsWith("*")||c.endsWith("/*"),`Route path "${c}" will be treated as if it were "${c.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${c.replace(/\*$/,"/*")}".`);let s=[],d="^"+c.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(T,D,x)=>(s.push({paramName:D,isOptional:x!=null}),x?"/?([^\\/]+)?":"/([^\\/]+)"));return c.endsWith("*")?(s.push({paramName:"*"}),d+=c==="*"||c==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):m?d+="\\/*$":c!==""&&c!=="/"&&(d+="(?:(?=\\/|$))"),[new RegExp(d,f?void 0:"i"),s]}function lg(c){try{return c.split("/").map(f=>decodeURIComponent(f).replace(/\//g,"%2F")).join("/")}catch(f){return Rt(!1,`The URL path "${c}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${f}).`),c}}function Jt(c,f){if(f==="/")return c;if(!c.toLowerCase().startsWith(f.toLowerCase()))return null;let m=f.endsWith("/")?f.length-1:f.length,s=c.charAt(m);return s&&s!=="/"?null:c.slice(m)||"/"}function ng(c,f="/"){let{pathname:m,search:s="",hash:d=""}=typeof c=="string"?zl(c):c;return{pathname:m?m.startsWith("/")?m:ig(m,f):f,search:cg(s),hash:ug(d)}}function ig(c,f){let m=f.replace(/\/+$/,"").split("/");return c.split("/").forEach(d=>{d===".."?m.length>1&&m.pop():d!=="."&&m.push(d)}),m.length>1?m.join("/"):"/"}function Tc(c,f,m,s){return`Cannot include a '${c}' character in a manually specified \`to.${f}\` field [${JSON.stringify(s)}].  Please separate it out to the \`to.${m}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function rg(c){return c.filter((f,m)=>m===0||f.route.path&&f.route.path.length>0)}function Kd(c){let f=rg(c);return f.map((m,s)=>s===f.length-1?m.pathname:m.pathnameBase)}function Jd(c,f,m,s=!1){let d;typeof c=="string"?d=zl(c):(d={...c},je(!d.pathname||!d.pathname.includes("?"),Tc("?","pathname","search",d)),je(!d.pathname||!d.pathname.includes("#"),Tc("#","pathname","hash",d)),je(!d.search||!d.search.includes("#"),Tc("#","search","hash",d)));let b=c===""||d.pathname==="",T=b?"/":d.pathname,D;if(T==null)D=m;else{let O=f.length-1;if(!s&&T.startsWith("..")){let _=T.split("/");for(;_[0]==="..";)_.shift(),O-=1;d.pathname=_.join("/")}D=O>=0?f[O]:"/"}let x=ng(d,D),p=T&&T!=="/"&&T.endsWith("/"),A=(b||T===".")&&m.endsWith("/");return!x.pathname.endsWith("/")&&(p||A)&&(x.pathname+="/"),x}var Kt=c=>c.join("/").replace(/\/\/+/g,"/"),og=c=>c.replace(/\/+$/,"").replace(/^\/*/,"/"),cg=c=>!c||c==="?"?"":c.startsWith("?")?c:"?"+c,ug=c=>!c||c==="#"?"":c.startsWith("#")?c:"#"+c;function sg(c){return c!=null&&typeof c.status=="number"&&typeof c.statusText=="string"&&typeof c.internal=="boolean"&&"data"in c}var Wd=["POST","PUT","PATCH","DELETE"];new Set(Wd);var fg=["GET",...Wd];new Set(fg);var Ml=R.createContext(null);Ml.displayName="DataRouter";var tr=R.createContext(null);tr.displayName="DataRouterState";R.createContext(!1);var $d=R.createContext({isTransitioning:!1});$d.displayName="ViewTransition";var dg=R.createContext(new Map);dg.displayName="Fetchers";var mg=R.createContext(null);mg.displayName="Await";var wt=R.createContext(null);wt.displayName="Navigation";var Cn=R.createContext(null);Cn.displayName="Location";var Wt=R.createContext({outlet:null,matches:[],isDataRoute:!1});Wt.displayName="Route";var Dc=R.createContext(null);Dc.displayName="RouteError";function hg(c,{relative:f}={}){je(On(),"useHref() may be used only in the context of a <Router> component.");let{basename:m,navigator:s}=R.useContext(wt),{hash:d,pathname:b,search:T}=Un(c,{relative:f}),D=b;return m!=="/"&&(D=b==="/"?m:Kt([m,b])),s.createHref({pathname:D,search:T,hash:d})}function On(){return R.useContext(Cn)!=null}function ka(){return je(On(),"useLocation() may be used only in the context of a <Router> component."),R.useContext(Cn).location}var Fd="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Id(c){R.useContext(wt).static||R.useLayoutEffect(c)}function Pd(){let{isDataRoute:c}=R.useContext(Wt);return c?zg():pg()}function pg(){je(On(),"useNavigate() may be used only in the context of a <Router> component.");let c=R.useContext(Ml),{basename:f,navigator:m}=R.useContext(wt),{matches:s}=R.useContext(Wt),{pathname:d}=ka(),b=JSON.stringify(Kd(s)),T=R.useRef(!1);return Id(()=>{T.current=!0}),R.useCallback((x,p={})=>{if(Rt(T.current,Fd),!T.current)return;if(typeof x=="number"){m.go(x);return}let A=Jd(x,JSON.parse(b),d,p.relative==="path");c==null&&f!=="/"&&(A.pathname=A.pathname==="/"?f:Kt([f,A.pathname])),(p.replace?m.replace:m.push)(A,p.state,p)},[f,m,b,d,c])}R.createContext(null);function Un(c,{relative:f}={}){let{matches:m}=R.useContext(Wt),{pathname:s}=ka(),d=JSON.stringify(Kd(m));return R.useMemo(()=>Jd(c,JSON.parse(d),s,f==="path"),[c,d,s,f])}function gg(c,f){return em(c,f)}function em(c,f,m,s){je(On(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d}=R.useContext(wt),{matches:b}=R.useContext(Wt),T=b[b.length-1],D=T?T.params:{},x=T?T.pathname:"/",p=T?T.pathnameBase:"/",A=T&&T.route;{let H=A&&A.path||"";tm(x,!A||H.endsWith("*")||H.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${x}" (under <Route path="${H}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${H}"> to <Route path="${H==="/"?"*":`${H}/*`}">.`)}let O=ka(),_;if(f){let H=typeof f=="string"?zl(f):f;je(p==="/"||H.pathname?.startsWith(p),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${p}" but pathname "${H.pathname}" was given in the \`location\` prop.`),_=H}else _=O;let k=_.pathname||"/",X=k;if(p!=="/"){let H=p.replace(/^\//,"").split("/");X="/"+k.replace(/^\//,"").split("/").slice(H.length).join("/")}let Q=Vd(c,{pathname:X});Rt(A||Q!=null,`No routes matched location "${_.pathname}${_.search}${_.hash}" `),Rt(Q==null||Q[Q.length-1].route.element!==void 0||Q[Q.length-1].route.Component!==void 0||Q[Q.length-1].route.lazy!==void 0,`Matched leaf route at location "${_.pathname}${_.search}${_.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let V=Sg(Q&&Q.map(H=>Object.assign({},H,{params:Object.assign({},D,H.params),pathname:Kt([p,d.encodeLocation?d.encodeLocation(H.pathname).pathname:H.pathname]),pathnameBase:H.pathnameBase==="/"?p:Kt([p,d.encodeLocation?d.encodeLocation(H.pathnameBase).pathname:H.pathnameBase])})),b,m,s);return f&&V?R.createElement(Cn.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",..._},navigationType:"POP"}},V):V}function vg(){let c=Ag(),f=sg(c)?`${c.status} ${c.statusText}`:c instanceof Error?c.message:JSON.stringify(c),m=c instanceof Error?c.stack:null,s="rgba(200,200,200, 0.5)",d={padding:"0.5rem",backgroundColor:s},b={padding:"2px 4px",backgroundColor:s},T=null;return console.error("Error handled by React Router default ErrorBoundary:",c),T=R.createElement(R.Fragment,null,R.createElement("p",null,"💿 Hey developer 👋"),R.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",R.createElement("code",{style:b},"ErrorBoundary")," or"," ",R.createElement("code",{style:b},"errorElement")," prop on your route.")),R.createElement(R.Fragment,null,R.createElement("h2",null,"Unexpected Application Error!"),R.createElement("h3",{style:{fontStyle:"italic"}},f),m?R.createElement("pre",{style:d},m):null,T)}var bg=R.createElement(vg,null),yg=class extends R.Component{constructor(c){super(c),this.state={location:c.location,revalidation:c.revalidation,error:c.error}}static getDerivedStateFromError(c){return{error:c}}static getDerivedStateFromProps(c,f){return f.location!==c.location||f.revalidation!=="idle"&&c.revalidation==="idle"?{error:c.error,location:c.location,revalidation:c.revalidation}:{error:c.error!==void 0?c.error:f.error,location:f.location,revalidation:c.revalidation||f.revalidation}}componentDidCatch(c,f){console.error("React Router caught the following error during render",c,f)}render(){return this.state.error!==void 0?R.createElement(Wt.Provider,{value:this.props.routeContext},R.createElement(Dc.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function xg({routeContext:c,match:f,children:m}){let s=R.useContext(Ml);return s&&s.static&&s.staticContext&&(f.route.errorElement||f.route.ErrorBoundary)&&(s.staticContext._deepestRenderedBoundaryId=f.route.id),R.createElement(Wt.Provider,{value:c},m)}function Sg(c,f=[],m=null,s=null){if(c==null){if(!m)return null;if(m.errors)c=m.matches;else if(f.length===0&&!m.initialized&&m.matches.length>0)c=m.matches;else return null}let d=c,b=m?.errors;if(b!=null){let x=d.findIndex(p=>p.route.id&&b?.[p.route.id]!==void 0);je(x>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(b).join(",")}`),d=d.slice(0,Math.min(d.length,x+1))}let T=!1,D=-1;if(m)for(let x=0;x<d.length;x++){let p=d[x];if((p.route.HydrateFallback||p.route.hydrateFallbackElement)&&(D=x),p.route.id){let{loaderData:A,errors:O}=m,_=p.route.loader&&!A.hasOwnProperty(p.route.id)&&(!O||O[p.route.id]===void 0);if(p.route.lazy||_){T=!0,D>=0?d=d.slice(0,D+1):d=[d[0]];break}}}return d.reduceRight((x,p,A)=>{let O,_=!1,k=null,X=null;m&&(O=b&&p.route.id?b[p.route.id]:void 0,k=p.route.errorElement||bg,T&&(D<0&&A===0?(tm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),_=!0,X=null):D===A&&(_=!0,X=p.route.hydrateFallbackElement||null)));let Q=f.concat(d.slice(0,A+1)),V=()=>{let H;return O?H=k:_?H=X:p.route.Component?H=R.createElement(p.route.Component,null):p.route.element?H=p.route.element:H=x,R.createElement(xg,{match:p,routeContext:{outlet:x,matches:Q,isDataRoute:m!=null},children:H})};return m&&(p.route.ErrorBoundary||p.route.errorElement||A===0)?R.createElement(yg,{location:m.location,revalidation:m.revalidation,component:k,error:O,children:V(),routeContext:{outlet:null,matches:Q,isDataRoute:!0}}):V()},null)}function Cc(c){return`${c} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function jg(c){let f=R.useContext(Ml);return je(f,Cc(c)),f}function Ng(c){let f=R.useContext(tr);return je(f,Cc(c)),f}function Eg(c){let f=R.useContext(Wt);return je(f,Cc(c)),f}function Oc(c){let f=Eg(c),m=f.matches[f.matches.length-1];return je(m.route.id,`${c} can only be used on routes that contain a unique "id"`),m.route.id}function Tg(){return Oc("useRouteId")}function Ag(){let c=R.useContext(Dc),f=Ng("useRouteError"),m=Oc("useRouteError");return c!==void 0?c:f.errors?.[m]}function zg(){let{router:c}=jg("useNavigate"),f=Oc("useNavigate"),m=R.useRef(!1);return Id(()=>{m.current=!0}),R.useCallback(async(d,b={})=>{Rt(m.current,Fd),m.current&&(typeof d=="number"?c.navigate(d):await c.navigate(d,{fromRouteId:f,...b}))},[c,f])}var Gd={};function tm(c,f,m){!f&&!Gd[c]&&(Gd[c]=!0,Rt(!1,m))}R.memo(Mg);function Mg({routes:c,future:f,state:m}){return em(c,void 0,m,f)}function Zt(c){je(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function Rg({basename:c="/",children:f=null,location:m,navigationType:s="POP",navigator:d,static:b=!1}){je(!On(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let T=c.replace(/^\/*/,"/"),D=R.useMemo(()=>({basename:T,navigator:d,static:b,future:{}}),[T,d,b]);typeof m=="string"&&(m=zl(m));let{pathname:x="/",search:p="",hash:A="",state:O=null,key:_="default"}=m,k=R.useMemo(()=>{let X=Jt(x,T);return X==null?null:{location:{pathname:X,search:p,hash:A,state:O,key:_},navigationType:s}},[T,x,p,A,O,_,s]);return Rt(k!=null,`<Router basename="${T}"> is not able to match the URL "${x}${p}${A}" because it does not start with the basename, so the <Router> won't render anything.`),k==null?null:R.createElement(wt.Provider,{value:D},R.createElement(Cn.Provider,{children:f,value:k}))}function wg({children:c,location:f}){return gg(Rc(c),f)}function Rc(c,f=[]){let m=[];return R.Children.forEach(c,(s,d)=>{if(!R.isValidElement(s))return;let b=[...f,d];if(s.type===R.Fragment){m.push.apply(m,Rc(s.props.children,b));return}je(s.type===Zt,`[${typeof s.type=="string"?s.type:s.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),je(!s.props.index||!s.props.children,"An index route cannot have child routes.");let T={id:s.props.id||b.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,loader:s.props.loader,action:s.props.action,hydrateFallbackElement:s.props.hydrateFallbackElement,HydrateFallback:s.props.HydrateFallback,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.hasErrorBoundary===!0||s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(T.children=Rc(s.props.children,b)),m.push(T)}),m}var Ii="get",Pi="application/x-www-form-urlencoded";function ar(c){return c!=null&&typeof c.tagName=="string"}function Dg(c){return ar(c)&&c.tagName.toLowerCase()==="button"}function Cg(c){return ar(c)&&c.tagName.toLowerCase()==="form"}function Og(c){return ar(c)&&c.tagName.toLowerCase()==="input"}function Ug(c){return!!(c.metaKey||c.altKey||c.ctrlKey||c.shiftKey)}function _g(c,f){return c.button===0&&(!f||f==="_self")&&!Ug(c)}var $i=null;function Hg(){if($i===null)try{new FormData(document.createElement("form"),0),$i=!1}catch{$i=!0}return $i}var Bg=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Ac(c){return c!=null&&!Bg.has(c)?(Rt(!1,`"${c}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Pi}"`),null):c}function Lg(c,f){let m,s,d,b,T;if(Cg(c)){let D=c.getAttribute("action");s=D?Jt(D,f):null,m=c.getAttribute("method")||Ii,d=Ac(c.getAttribute("enctype"))||Pi,b=new FormData(c)}else if(Dg(c)||Og(c)&&(c.type==="submit"||c.type==="image")){let D=c.form;if(D==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let x=c.getAttribute("formaction")||D.getAttribute("action");if(s=x?Jt(x,f):null,m=c.getAttribute("formmethod")||D.getAttribute("method")||Ii,d=Ac(c.getAttribute("formenctype"))||Ac(D.getAttribute("enctype"))||Pi,b=new FormData(D,c),!Hg()){let{name:p,type:A,value:O}=c;if(A==="image"){let _=p?`${p}.`:"";b.append(`${_}x`,"0"),b.append(`${_}y`,"0")}else p&&b.append(p,O)}}else{if(ar(c))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');m=Ii,s=null,d=Pi,T=c}return b&&d==="text/plain"&&(T=b,b=void 0),{action:s,method:m.toLowerCase(),encType:d,formData:b,body:T}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Uc(c,f){if(c===!1||c===null||typeof c>"u")throw new Error(f)}function qg(c,f,m){let s=typeof c=="string"?new URL(c,typeof window>"u"?"server://singlefetch/":window.location.origin):c;return s.pathname==="/"?s.pathname=`_root.${m}`:f&&Jt(s.pathname,f)==="/"?s.pathname=`${f.replace(/\/$/,"")}/_root.${m}`:s.pathname=`${s.pathname.replace(/\/$/,"")}.${m}`,s}async function Yg(c,f){if(c.id in f)return f[c.id];try{let m=await import(c.module);return f[c.id]=m,m}catch(m){return console.error(`Error loading route module \`${c.module}\`, reloading page...`),console.error(m),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function kg(c){return c==null?!1:c.href==null?c.rel==="preload"&&typeof c.imageSrcSet=="string"&&typeof c.imageSizes=="string":typeof c.rel=="string"&&typeof c.href=="string"}async function Gg(c,f,m){let s=await Promise.all(c.map(async d=>{let b=f.routes[d.route.id];if(b){let T=await Yg(b,m);return T.links?T.links():[]}return[]}));return Zg(s.flat(1).filter(kg).filter(d=>d.rel==="stylesheet"||d.rel==="preload").map(d=>d.rel==="stylesheet"?{...d,rel:"prefetch",as:"style"}:{...d,rel:"prefetch"}))}function Xd(c,f,m,s,d,b){let T=(x,p)=>m[p]?x.route.id!==m[p].route.id:!0,D=(x,p)=>m[p].pathname!==x.pathname||m[p].route.path?.endsWith("*")&&m[p].params["*"]!==x.params["*"];return b==="assets"?f.filter((x,p)=>T(x,p)||D(x,p)):b==="data"?f.filter((x,p)=>{let A=s.routes[x.route.id];if(!A||!A.hasLoader)return!1;if(T(x,p)||D(x,p))return!0;if(x.route.shouldRevalidate){let O=x.route.shouldRevalidate({currentUrl:new URL(d.pathname+d.search+d.hash,window.origin),currentParams:m[0]?.params||{},nextUrl:new URL(c,window.origin),nextParams:x.params,defaultShouldRevalidate:!0});if(typeof O=="boolean")return O}return!0}):[]}function Xg(c,f,{includeHydrateFallback:m}={}){return Vg(c.map(s=>{let d=f.routes[s.route.id];if(!d)return[];let b=[d.module];return d.clientActionModule&&(b=b.concat(d.clientActionModule)),d.clientLoaderModule&&(b=b.concat(d.clientLoaderModule)),m&&d.hydrateFallbackModule&&(b=b.concat(d.hydrateFallbackModule)),d.imports&&(b=b.concat(d.imports)),b}).flat(1))}function Vg(c){return[...new Set(c)]}function Qg(c){let f={},m=Object.keys(c).sort();for(let s of m)f[s]=c[s];return f}function Zg(c,f){let m=new Set;return new Set(f),c.reduce((s,d)=>{let b=JSON.stringify(Qg(d));return m.has(b)||(m.add(b),s.push({key:b,link:d})),s},[])}function am(){let c=R.useContext(Ml);return Uc(c,"You must render this element inside a <DataRouterContext.Provider> element"),c}function Kg(){let c=R.useContext(tr);return Uc(c,"You must render this element inside a <DataRouterStateContext.Provider> element"),c}var _c=R.createContext(void 0);_c.displayName="FrameworkContext";function lm(){let c=R.useContext(_c);return Uc(c,"You must render this element inside a <HydratedRouter> element"),c}function Jg(c,f){let m=R.useContext(_c),[s,d]=R.useState(!1),[b,T]=R.useState(!1),{onFocus:D,onBlur:x,onMouseEnter:p,onMouseLeave:A,onTouchStart:O}=f,_=R.useRef(null);R.useEffect(()=>{if(c==="render"&&T(!0),c==="viewport"){let Q=H=>{H.forEach(re=>{T(re.isIntersecting)})},V=new IntersectionObserver(Q,{threshold:.5});return _.current&&V.observe(_.current),()=>{V.disconnect()}}},[c]),R.useEffect(()=>{if(s){let Q=setTimeout(()=>{T(!0)},100);return()=>{clearTimeout(Q)}}},[s]);let k=()=>{d(!0)},X=()=>{d(!1),T(!1)};return m?c!=="intent"?[b,_,{}]:[b,_,{onFocus:Rn(D,k),onBlur:Rn(x,X),onMouseEnter:Rn(p,k),onMouseLeave:Rn(A,X),onTouchStart:Rn(O,k)}]:[!1,_,{}]}function Rn(c,f){return m=>{c&&c(m),m.defaultPrevented||f(m)}}function Wg({page:c,...f}){let{router:m}=am(),s=R.useMemo(()=>Vd(m.routes,c,m.basename),[m.routes,c,m.basename]);return s?R.createElement(Fg,{page:c,matches:s,...f}):null}function $g(c){let{manifest:f,routeModules:m}=lm(),[s,d]=R.useState([]);return R.useEffect(()=>{let b=!1;return Gg(c,f,m).then(T=>{b||d(T)}),()=>{b=!0}},[c,f,m]),s}function Fg({page:c,matches:f,...m}){let s=ka(),{manifest:d,routeModules:b}=lm(),{basename:T}=am(),{loaderData:D,matches:x}=Kg(),p=R.useMemo(()=>Xd(c,f,x,d,s,"data"),[c,f,x,d,s]),A=R.useMemo(()=>Xd(c,f,x,d,s,"assets"),[c,f,x,d,s]),O=R.useMemo(()=>{if(c===s.pathname+s.search+s.hash)return[];let X=new Set,Q=!1;if(f.forEach(H=>{let re=d.routes[H.route.id];!re||!re.hasLoader||(!p.some(P=>P.route.id===H.route.id)&&H.route.id in D&&b[H.route.id]?.shouldRevalidate||re.hasClientLoader?Q=!0:X.add(H.route.id))}),X.size===0)return[];let V=qg(c,T,"data");return Q&&X.size>0&&V.searchParams.set("_routes",f.filter(H=>X.has(H.route.id)).map(H=>H.route.id).join(",")),[V.pathname+V.search]},[T,D,s,d,p,f,c,b]),_=R.useMemo(()=>Xg(A,d),[A,d]),k=$g(A);return R.createElement(R.Fragment,null,O.map(X=>R.createElement("link",{key:X,rel:"prefetch",as:"fetch",href:X,...m})),_.map(X=>R.createElement("link",{key:X,rel:"modulepreload",href:X,...m})),k.map(({key:X,link:Q})=>R.createElement("link",{key:X,...Q})))}function Ig(...c){return f=>{c.forEach(m=>{typeof m=="function"?m(f):m!=null&&(m.current=f)})}}var nm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{nm&&(window.__reactRouterVersion="7.7.0")}catch{}function Pg({basename:c,children:f,window:m}){let s=R.useRef();s.current==null&&(s.current=kp({window:m,v5Compat:!0}));let d=s.current,[b,T]=R.useState({action:d.action,location:d.location}),D=R.useCallback(x=>{R.startTransition(()=>T(x))},[T]);return R.useLayoutEffect(()=>d.listen(D),[d,D]),R.createElement(Rg,{basename:c,children:f,location:b.location,navigationType:b.action,navigator:d})}var im=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,wn=R.forwardRef(function({onClick:f,discover:m="render",prefetch:s="none",relative:d,reloadDocument:b,replace:T,state:D,target:x,to:p,preventScrollReset:A,viewTransition:O,..._},k){let{basename:X}=R.useContext(wt),Q=typeof p=="string"&&im.test(p),V,H=!1;if(typeof p=="string"&&Q&&(V=p,nm))try{let Ne=new URL(window.location.href),Pe=p.startsWith("//")?new URL(Ne.protocol+p):new URL(p),st=Jt(Pe.pathname,X);Pe.origin===Ne.origin&&st!=null?p=st+Pe.search+Pe.hash:H=!0}catch{Rt(!1,`<Link to="${p}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let re=hg(p,{relative:d}),[P,xe,F]=Jg(s,_),Oe=l0(p,{replace:T,state:D,target:x,preventScrollReset:A,relative:d,viewTransition:O});function we(Ne){f&&f(Ne),Ne.defaultPrevented||Oe(Ne)}let Ue=R.createElement("a",{..._,...F,href:V||re,onClick:H||b?f:we,ref:Ig(k,xe),target:x,"data-discover":!Q&&m==="render"?"true":void 0});return P&&!Q?R.createElement(R.Fragment,null,Ue,R.createElement(Wg,{page:re})):Ue});wn.displayName="Link";var e0=R.forwardRef(function({"aria-current":f="page",caseSensitive:m=!1,className:s="",end:d=!1,style:b,to:T,viewTransition:D,children:x,...p},A){let O=Un(T,{relative:p.relative}),_=ka(),k=R.useContext(tr),{navigator:X,basename:Q}=R.useContext(wt),V=k!=null&&c0(O)&&D===!0,H=X.encodeLocation?X.encodeLocation(O).pathname:O.pathname,re=_.pathname,P=k&&k.navigation&&k.navigation.location?k.navigation.location.pathname:null;m||(re=re.toLowerCase(),P=P?P.toLowerCase():null,H=H.toLowerCase()),P&&Q&&(P=Jt(P,Q)||P);const xe=H!=="/"&&H.endsWith("/")?H.length-1:H.length;let F=re===H||!d&&re.startsWith(H)&&re.charAt(xe)==="/",Oe=P!=null&&(P===H||!d&&P.startsWith(H)&&P.charAt(H.length)==="/"),we={isActive:F,isPending:Oe,isTransitioning:V},Ue=F?f:void 0,Ne;typeof s=="function"?Ne=s(we):Ne=[s,F?"active":null,Oe?"pending":null,V?"transitioning":null].filter(Boolean).join(" ");let Pe=typeof b=="function"?b(we):b;return R.createElement(wn,{...p,"aria-current":Ue,className:Ne,ref:A,style:Pe,to:T,viewTransition:D},typeof x=="function"?x(we):x)});e0.displayName="NavLink";var t0=R.forwardRef(({discover:c="render",fetcherKey:f,navigate:m,reloadDocument:s,replace:d,state:b,method:T=Ii,action:D,onSubmit:x,relative:p,preventScrollReset:A,viewTransition:O,..._},k)=>{let X=r0(),Q=o0(D,{relative:p}),V=T.toLowerCase()==="get"?"get":"post",H=typeof D=="string"&&im.test(D),re=P=>{if(x&&x(P),P.defaultPrevented)return;P.preventDefault();let xe=P.nativeEvent.submitter,F=xe?.getAttribute("formmethod")||T;X(xe||P.currentTarget,{fetcherKey:f,method:F,navigate:m,replace:d,state:b,relative:p,preventScrollReset:A,viewTransition:O})};return R.createElement("form",{ref:k,method:V,action:Q,onSubmit:s?x:re,..._,"data-discover":!H&&c==="render"?"true":void 0})});t0.displayName="Form";function a0(c){return`${c} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function rm(c){let f=R.useContext(Ml);return je(f,a0(c)),f}function l0(c,{target:f,replace:m,state:s,preventScrollReset:d,relative:b,viewTransition:T}={}){let D=Pd(),x=ka(),p=Un(c,{relative:b});return R.useCallback(A=>{if(_g(A,f)){A.preventDefault();let O=m!==void 0?m:Dn(x)===Dn(p);D(c,{replace:O,state:s,preventScrollReset:d,relative:b,viewTransition:T})}},[x,D,p,m,s,f,c,d,b,T])}var n0=0,i0=()=>`__${String(++n0)}__`;function r0(){let{router:c}=rm("useSubmit"),{basename:f}=R.useContext(wt),m=Tg();return R.useCallback(async(s,d={})=>{let{action:b,method:T,encType:D,formData:x,body:p}=Lg(s,f);if(d.navigate===!1){let A=d.fetcherKey||i0();await c.fetch(A,m,d.action||b,{preventScrollReset:d.preventScrollReset,formData:x,body:p,formMethod:d.method||T,formEncType:d.encType||D,flushSync:d.flushSync})}else await c.navigate(d.action||b,{preventScrollReset:d.preventScrollReset,formData:x,body:p,formMethod:d.method||T,formEncType:d.encType||D,replace:d.replace,state:d.state,fromRouteId:m,flushSync:d.flushSync,viewTransition:d.viewTransition})},[c,f,m])}function o0(c,{relative:f}={}){let{basename:m}=R.useContext(wt),s=R.useContext(Wt);je(s,"useFormAction must be used inside a RouteContext");let[d]=s.matches.slice(-1),b={...Un(c||".",{relative:f})},T=ka();if(c==null){b.search=T.search;let D=new URLSearchParams(b.search),x=D.getAll("index");if(x.some(A=>A==="")){D.delete("index"),x.filter(O=>O).forEach(O=>D.append("index",O));let A=D.toString();b.search=A?`?${A}`:""}}return(!c||c===".")&&d.route.index&&(b.search=b.search?b.search.replace(/^\?/,"?index&"):"?index"),m!=="/"&&(b.pathname=b.pathname==="/"?m:Kt([m,b.pathname])),Dn(b)}function c0(c,f={}){let m=R.useContext($d);je(m!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:s}=rm("useViewTransitionState"),d=Un(c,{relative:f.relative});if(!m.isTransitioning)return!1;let b=Jt(m.currentLocation.pathname,s)||m.currentLocation.pathname,T=Jt(m.nextLocation.pathname,s)||m.nextLocation.pathname;return er(d.pathname,T)!=null||er(d.pathname,b)!=null}const u0=()=>{const[c,f]=R.useState(!1),m=[{to:"/",label:"Home"},{to:"/experience",label:"Experience"},{to:"/projects",label:"Projects"},{to:"/certifications",label:"Certifications"}];return r.jsxs("nav",{className:"retro-navbar",children:[r.jsx("div",{className:"retro-navbar-left",children:r.jsxs(wn,{to:"/",className:"retro-navbar-brand",children:["Hello!",r.jsx("br",{}),"I am Charchit"]})}),r.jsxs("div",{className:"retro-navbar-right",children:[r.jsx("div",{className:"retro-navbar-links",children:m.map(s=>r.jsx(wn,{to:s.to,className:"retro-navbar-link",children:s.label},s.to))}),r.jsxs("button",{className:"retro-navbar-hamburger","aria-label":"Open navigation menu","aria-expanded":c,onClick:()=>f(s=>!s),children:[r.jsx("span",{className:"retro-navbar-hamburger-bar"}),r.jsx("span",{className:"retro-navbar-hamburger-bar"}),r.jsx("span",{className:"retro-navbar-hamburger-bar"})]}),c&&r.jsx("div",{className:"retro-navbar-mobile-menu",children:m.map(s=>r.jsx(wn,{to:s.to,className:"retro-navbar-mobile-link",onClick:()=>f(!1),children:s.label},s.to))})]}),r.jsx("style",{children:`
        .retro-navbar {
          width: 100%;
          background: #fff;
          color: #000;
    ...
    `})]})}const zc=({title:c,description:f,images:m,imagePosition:s="left",readMoreLink:d})=>{const b=Pd(),[T,D]=R.useState(0),x=R.useRef(null),p=()=>{m.length<=1||(x.current=window.setInterval(()=>{D(k=>(k+1)%m.length)},900))},A=()=>{x.current&&window.clearInterval(x.current),D(0)},O=r.jsx("div",{className:"retro-exp-img-section",onMouseEnter:p,onMouseLeave:A,children:r.jsx("img",{src:m[T],alt:c,className:"retro-exp-img"})}),_=r.jsxs("div",{className:"retro-exp-text-section",children:[r.jsx("div",{className:"retro-exp-title",children:c}),r.jsx("div",{className:"retro-exp-desc",children:f}),d&&r.jsx("button",{className:"retro-exp-btn",onClick:()=>b(d),children:"Read More"})]});return r.jsxs("div",{className:`retro-exp-block ${s==="left"?"left":"right"}`,children:[_,O,r.jsx("style",{children:`
      ...
      `})]});function x0(){return r.jsxs("section",{className:"retro-cert-section",children:[r.jsxs("div",{className:"retro-cert-container",children:[r.jsx("h1",{className:"retro-cert-heading",children:"Certifications"}),r.jsxs("div",{className:"retro-cert-grid",children:[r.jsx(Fi,{name:"AWS Cloud Developing",description:"AWS Certified Developer  Associate. Demonstrated expertise in developing and maintaining AWS-based applications.",image:g0,link:"#"}),r.jsx(Fi,{name:"AWS Cloud Foundation",description:"AWS Certified Cloud Practitioner. Validated foundational knowledge of AWS Cloud and global infrastructure.",image:v0,link:"#"}),r.jsx(Fi,{name:"NVIDIA",description:"NVIDIA Deep Learning Institute Certificate. Completed hands-on training in deep learning and AI.",image:b0,link:"#"}),r.jsx(Fi,{name:"Flutter",description:"Flutter Development Certificate. Built cross-platform mobile apps using Flutter and Dart.",image:y0,link:"#"})]})]}),r.jsx("style",{children:`
        .retro-cert-section {
          background: #fff;
          color: #000;
          min-height: 100vh;
      ...
      `})]})}function z0(){return r.jsxs(Pg,{children:[r.jsx(u0,{}),r.jsxs(wg,{children:[r.jsx(Zt,{path:"/",element:r.jsx(f0,{})}),r.jsx(Zt,{path:"/experience",element:r.jsx(m0,{})}),r.jsx(Zt,{path:"/projects",element:r.jsx(p0,{})}),r.jsx(Zt,{path:"/certifications",element:r.jsx(x0,{})}),r.jsx(Zt,{path:"/experience/fad",element:r.jsx(N0,{})}),r.jsx(Zt,{path:"/experience/isa",element:r.jsx(E0,{})}),r.jsx(Zt,{path:"/experience/bootcamp",element:r.jsx(T0,{})}),r.jsx(Zt,{path:"/experience/internship",element:r.jsx(A0,{})})]})]})}Yp.createRoot(document.getElementById("root")).render(r.jsx(R.StrictMode,{children:r.jsx(z0,{})}));
